...
(function () {
  ...
  var DICT = {
    es: {
      ...
      "discount.title": "Descuento", "discount.apply": "Aplicar descuento",
      "form.discount.percent": "Porcentaje de descuento", "form.discount.starts": "Inicio (opcional)",
      "form.discount.ends": "Fin (opcional)", "discount.listPrice": "Precio normal",
      "discount.savings": "Ahorro", "discount.finalPrice": "Precio final con IVA",
      "discount.invalidPercent": "Ingresa un porcentaje entre 1 y 90.",
      "discount.from": "Desde", "discount.total": "Descuentos",
      "discount.scheduled": "Programada", "discount.expired": "Finalizada",
      "discount.status.none": "Sin descuento", "discount.status.scheduled": "Promoción programada",
      "discount.status.active": "Promoción activa", "discount.status.expired": "Promoción finalizada",
      "discount.a11y": "{percent}% de descuento; antes {before}, ahora {now}",
      "discount.cartUpdated": "Se actualizaron {n} precio(s) del carrito.",
      "discount.posUpdated": "Los precios cambiaron. Revisa el total antes de cobrar.",
      ...
      "volumes.priceStockHint": "Precio · stock a sumar por tomo (precio vacío = no se crea)",
      "volumes.rowHint": "Precio y stock por tomo",
      "volumes.priceBtn": "Precio",
      "volumes.stockBtn": "Stock",
      "volumes.priceTitle": "Precio · {name}",
      "volumes.stockTitle": "Stock · {name}",
      "volumes.addStock": "Sumar al stock (sucursal)",
      "volumes.curStock": "Stock actual",
      ...
      "resv.nonbinding": "Precio sujeto a confirmación en sucursal",
      ...
      "register.submit": "Registrarse", "register.continue": "Continuar",
      "register.prevStep": "Paso anterior",
    ...
    en: {
      ...
      "discount.title": "Discount", "discount.apply": "Apply discount",
      "form.discount.percent": "Discount percentage", "form.discount.starts": "Start (optional)",
      "form.discount.ends": "End (optional)", "discount.listPrice": "Regular price",
      "discount.savings": "Savings", "discount.finalPrice": "Final price incl. tax",
      "discount.invalidPercent": "Enter a percentage between 1 and 90.",
      "discount.from": "From", "discount.total": "Discounts",
      "discount.scheduled": "Scheduled", "discount.expired": "Ended",
      "discount.status.none": "No discount", "discount.status.scheduled": "Scheduled promotion",
      "discount.status.active": "Active promotion", "discount.status.expired": "Ended promotion",
      "discount.a11y": "{percent}% off; was {before}, now {now}",
      "discount.cartUpdated": "Updated {n} cart price(s).",
      "discount.posUpdated": "Prices changed. Review the total before charging.",
      ...
      "volumes.priceStockHint": "Price · stock to add per volume (blank price = not created)",
      "volumes.rowHint": "Price & stock per volume",
      "volumes.priceBtn": "Price",
      "volumes.stockBtn": "Stock",
      "volumes.priceTitle": "Price · {name}",
      "volumes.stockTitle": "Stock · {name}",
      "volumes.addStock": "Add to stock (branch)",
      "volumes.curStock": "Current stock",
      ...
      "resv.nonbinding": "Price subject to confirmation at the store",
      ...
      "register.submit": "Sign up for an account", "register.continue": "Continue",
